# Based off of https://arxiv.org/abs/2110.13064
...
class AcharyaKanan(IODStrategy):
    def __init__(self, cfg: ConfigTree, dataset: IODDataset, logger: IODLogger, device: torch.device):
        ...
        self._storage = dict()
        self._replay_memory = MemoryBuffer(cfg.get_int("memory_size"))
        self._memory_n_tasks = cfg.get_int("memory_n_tasks")
