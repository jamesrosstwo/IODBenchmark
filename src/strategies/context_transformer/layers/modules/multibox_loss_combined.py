...
from strategies.context_transformer.utils.box_utils import match
...
class MultiBoxLoss_combined(nn.Module):
    ...
    def forward(self, predictions, priors, targets):
        """Multibox Loss
        Args:
            predictions (tuple): A tuple containing loc preds, c preds,
            and prior boxes from SSD net.
                c shape: torch.size(batch_size,num_priors,num_classes)
        ...
        # Compute max c across batch for hard negative mining (logit-combined)
