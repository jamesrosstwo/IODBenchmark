...
from strategies.context_transformer.utils.box_utils import decode


class Detect(Function):
    """At test time, Detect is the final layer of SSD.  Decode location preds,
    apply non-maximum suppression to location predictions based on c
    ...
    def forward(self, predictions, prior):
        ...
        Args:
            ...
            conf_data: (tensor) Shape: Conf preds from c layers
        ...
        for i in range(num):
            ...
            conf_scores = obj_data[i, :, 1].unsqueeze(1).expand_as(conf_scores).mul(conf_scores) # c score multiply the obj score
